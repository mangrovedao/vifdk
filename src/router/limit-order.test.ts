...
describe('Limit order', () => {
	...
	it('should create a limit order, and parse it correctly', async () => {
		...
		expect(parsedSimulationResult[0].success).toBe(true)
		...
		expect(parsedSimulationResult[1].success).toBe(true)
		...
		expect(parsedSimulationResult[2].success).toBe(true)
		...
		expect(parsedSimulationResult[3].success).toBe(true)
		...
		expect(parsedSimulationResult[4].success).toBe(true)
		...
		expect(parsedReceipt[0].success).toBe(true)
		...
		expect(parsedReceipt[1].success).toBe(true)
