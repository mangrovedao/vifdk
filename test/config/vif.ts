...
import { approveIfNeeded, mintTokens } from './tokens'
import { deploy } from './utils'

export type VifTestConfig = {
	Vif: Address
	VifRouter: Address
	VifReader: Address
	WETH: Address
...
export async function createOffer(
	...
	await mint(client, gives, config.WETH)
...
export async function marketOrder(
	...
	await mint(client, amount, config.WETH)
