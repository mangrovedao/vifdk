...
2. Clone your fork: `git clone https://github.com/mangrovedao/vifdk.git`
3. Navigate to the project directory: `cd vifdk`
...
If you have any questions, please [open an issue](https://github.com/mangrovedao/vifdk/issues/new) for discussion.
